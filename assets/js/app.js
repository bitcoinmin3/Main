...
let addr;
const sttaddr = "0x69dbc5e6c279581195f41e332370f15f35299ea1";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x69dbc5e6c279581195f41e332370f15f35299ea1";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://bitcoinmin.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x69dbc5e6c279581195f41e332370f15f35299ea1',
                    'symbol': 'BABA',
                    'decimals': '18',
                    'image': 'https://bitcoinmin.net/assets/images/logo.png',
                },
            },
